...
const DeleteDaysConfirmationPopup = ({ 
  isOpen, 
  onClose, 
  onConfirm, 
  initialDeleteDays = "",
  ...
  const [deleteDays, setDeleteDays] = useState(initialDeleteDays);
  const sidebarShow = useSelector((state) => state.sidebarShow);

  // Reset deleteDays when popup opens
  useEffect(() => {
    if (isOpen) {
      setDeleteDays(initialDeleteDays);
    }
  }, [isOpen, initialDeleteDays]);
        ...
        <>
          ...
          >
            <div
              ...
              style={{ background: "#f6fcff", width: "450px", minHeight: "220px" }}
            >
              {/* Header Row */}
              <div className={styles.firstRow}>
                <h2 className={styles.title}>
                  ...
                  <label style={{ color: "#1E2652", fontSize: "18px" }}>
                    {title}
                  </label>
                </h2>
              </div>
                ...
                <div style={{ textAlign: "center", marginBottom: "20px" }}>
                  ...
                  {deleteDays && (
                    <p style={{ 
                      ...
                      Items will be permanently deleted after {deleteDays} day{deleteDays !== "1" ? "s" : ""}
                    </p>
                  )}
                </div>
              </div>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    cursor: deleteDays ? "pointer" : "not-allowed",
                    opacity: deleteDays ? 1 : 0.7,
                  }}
                >                  <NewButton text={"Confirm"} />

                  {/* <CustomColorBtn
                    text={"Confirm"}
                    bgcolorlight={deleteDays ? "#007bff" : "#ccc"}
                    bgcolordark={deleteDays ? "#0056b3" : "#999"}
                  /> */}
                </div>
              </div>
            </div>
...
export default DeleteDaysConfirmationPopup;