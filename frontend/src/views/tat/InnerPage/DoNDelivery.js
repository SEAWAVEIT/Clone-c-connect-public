...
const DoNDelivery = () => {
    ...
    async function fetchAllDND() {
        try {
            const response = await axios.get(`${API_BASE_URL}/getDoNDelivery`, {
                params: {
    ...
    const storeDND = async (e) => {
        try {
            e.preventDefault();
            const response = await axios.post(`${API_BASE_URL}/storeDND`, {
    ...
    async function handleUpdate() {
        try {
            const response = await axios.put(`${API_BASE_URL}/updateDND`, {
                tatimpcolumn: typeofDNData.typeofDN,
                days: typeofDNData.days,
                hours: typeofDNData.hours,
                minutes: typeofDNData.minutes,
    ...
    async function handleDelete(id) {
        try {
            const deletedDNDrow = await axios.delete(`${API_BASE_URL}/deleteDND`, {
                data: {
                    orgname: localStorage.getItem('orgname'),
                    orgcode: localStorage.getItem('orgcode'),
                    deletionrowid: id
        ...
        <div>
            ...
            >
                ...
                <CModalFooter>
                    ...
                    {editData ?
                        <CButton color="secondary" style={{ backgroundColor: 'blue', color: 'white' }} onClick={handleUpdate}>Save O2D</CButton>
                        :
