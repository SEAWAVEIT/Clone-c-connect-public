...
export default O2DTAT;
    ...
    //     //         ...prevState,
    //     //         [name]: checked ? name : '' // Save only the specific property corresponding to the checkbox
    //     //     }));
    ...
    //         // Save the state with the new value for the specified field
    ...
    //             {changeapplytoupdate ?
    //                 <CButton onClick={handleUpdate}>Save</CButton>
    //                 :
