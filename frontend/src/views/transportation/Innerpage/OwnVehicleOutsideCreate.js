...
function OwnVehicleOutsideCreate() {
    ...
    <div>
      ...
      <CCard className="card-body-1">
        <CCardBody>
          ...
          <div>
            <label className="transport-label">Container No.</label>
            <input />
          </div>
      ...
      <CCard className="card-body-1">
        <CCardBody className="grid-transport-section">
          ...
          <div>
            <label className="transport-label-grid-section">Contact Details</label>
            <input />
          </div>
          ...
          <div>
            <label className="transport-label-grid-section">Amount Recieved</label>
            <input />
          </div>
...
export default OwnVehicleOutsideCreate
