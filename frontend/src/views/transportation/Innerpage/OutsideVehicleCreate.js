...
function OutsideVehicleCreate() {
  const navigate = useNavigate()
  const closeBtnNavigate = () =>{
    navigate("/AllTransportation")
  }
  return (
    <div>
      ...
      <CCard className="card-body-1">
        <CCardBody>
          ...
          <div>
            <label className="transport-label">Transporter Name</label>
            <input value="Uneed" readOnly />
          </div>
        </CCardBody>
      </CCard>
      ...
      <CCard className="card-body-1">
        <CCardBody className="grid-transport-section">
          ...
          <div>
            <label className="transport-label-grid-section">LR No</label>
            <input />
          </div>
          ...
          <div>
            <label className="transport-label-grid-section">Advance Paid</label>
            <input />
          </div>
...
export default OutsideVehicleCreate;
