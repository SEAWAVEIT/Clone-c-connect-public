  ...
  return (
    ...
    <CCard className="card-body-1">
      <CCardBody>
        ...
        <div>
          <label className="transport-label">EMI Month</label>
          <input />
        </div>
        <div>
          <label className="transport-label">EMI Amount</label>
          <input />
        </div>
...
export default EMIVehicleCreate