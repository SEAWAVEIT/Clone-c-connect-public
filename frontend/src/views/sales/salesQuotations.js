...
import styles from "./css/salesQuotations.module.css";
...
import RightArrowInactive from "../buttons/buttons/RightArrowInactive";
...
function salesQuotations() {
  ...
  const [activeTab, setactiveTab] = useState("Quotations sent to Customer");
  const tabs = ["Quotations sent to Customer", "Pending Quotations"];
    ...
    >
      <div className={styles.container}>
        <div className={styles.firstRow}>
          ...
          <div className={styles.salesBox}>
            <div className={styles.outerBoxSalesTitle}>
              ...
              <div className={styles.salesTitle}> Sales: Quotations </div>
              <span>
                <RightArrowInactive />
              </span>
            </div>
            <div
              ...
              onDoubleClick={() => navigate("/Quotation")}
            >
              Total No. of Quotations: 23
        ...
        <div className={styles.fifthRow}>
          {" "}
          {activeTab === "Quotations sent to Customer" && (
            <motion.div
