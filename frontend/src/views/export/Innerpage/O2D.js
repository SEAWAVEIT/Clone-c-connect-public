...
const O2D = () => {
    ...
    const handleRemarksChange = (e, index) => {
        ...
        const newData = [...allo2dData];
        newData[index].remarks = remarksValue; // Save remarks property of the corresponding row
        setallo2dData(newData);
    };
                                    ...
                                    <input
                                        ...
                                        onChange={async (e) => {
                                            ...
                                            if (index === 0 && isEditable(item, index)) {
                                                ...
                                                updatedData[index].planDate = newValue; // Save the planDate for the row
                                                setallo2dData(updatedData); // Save the state with the modified data
