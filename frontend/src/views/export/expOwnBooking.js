...
import styles from "./css/expOwnBooking.module.css";
    ...
    >
      <div className={styles.container}>
        ...
        <div className={styles.thirdRow}>
          <div className={styles.tableTitle}>Profit Analysis for Export</div>
          <div className={styles.graphMainContainer}>
            <div className={styles.graphInnerBox}>
              <div className={styles.graphTitle}>
                ...
                >
                  Count of services provided for Export: 35
                </label>
              </div>
            ...
            <div className={styles.graphInnerBox}>
              <div className={styles.graphTitle}>
                ...
                >
                  Profit generated from Export services: 75
                </label>
              </div>
              <div className={styles.graph}></div>
            </div>
