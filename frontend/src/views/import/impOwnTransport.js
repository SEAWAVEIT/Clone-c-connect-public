...
import styles from "./css/impOwnTransport.module.css";
      ...
      <div className={styles.container}>
        <div className={styles.firstRow}>
          ...
          <div className={styles.impTransBox}>
            <div className={styles.impTransTitle}>Own Transportation</div>
            <div className={styles.impTransTotalJobs}>
            ...
            <div className={styles.innerContainer}>
              ...
              <div className={styles.subBox}>
                <div className={styles.subTitle}>
                  Total Transport Enquiries received for Import:
                </div>
                <div className={styles.subNo}>23</div>
              </div>
              <div className={styles.subBox}>
