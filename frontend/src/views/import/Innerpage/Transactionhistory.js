...
const Transactionhistory = () => {
  ...
  return (
    ...
    >
      ...
      >
        <CModalHeader onClose={() => setTransactionModal(false)}>
        ...
        <CModalBody>
          <div>
            ...
            <input
              ...
              name="date"
              value={collectionData.date || ""} // Ensure it defaults to an empty string if undefined
              disabled
            />
          </div>
          <div>
        ...
        <CModalFooter>
          <CButton color="secondary" onClick={() => setTransactionModal(false)}>
            Close
          </CButton>
        </CModalFooter>
      </CModal>
